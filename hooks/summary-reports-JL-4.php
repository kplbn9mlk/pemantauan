<?php
	...
	$x = new StdClass;
	$x->TableTitle = "STATUS PELAKSANAAN PROJEK";
	...
	$config_array = array(
		'reportHash' => 'thivalolxwq8ab8745l3',
		'request' => $_REQUEST,
		'groups_array' => $groups_array,
		'override_permissions' => false,
		'title' => 'STATUS PELAKSANAAN PROJEK',
		'custom_where' => '',
		'table' => 'JL',
		'label' => 'Status',
		'group_function' => 'count',
		'label_title' => 'Status',
		'value_title' => 'Count of J.LADANG DE',
		'thousands_separator' => ',',
		'decimal_point' => '.',
