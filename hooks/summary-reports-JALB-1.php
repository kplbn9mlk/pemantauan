<?php
	...
	$x = new StdClass;
	$x->TableTitle = "PERUNTUKAN DILULUSKAN";
	...
	$config_array = array(
		'reportHash' => 'y0u2w8yss5xiaos34swg',
		'request' => $_REQUEST,
		'groups_array' => $groups_array,
		'override_permissions' => false,
		'title' => 'PERUNTUKAN DILULUSKAN',
		'custom_where' => '',
		'table' => 'JALB',
		'label' => 'negeri',
		'group_function' => 'sum',
		'label_title' => 'Negeri',
		'value_title' => 'Sum of JALAN LUAR BANDAR',
		'thousands_separator' => ',',
		'decimal_point' => '.',
		...
		'group_function_field' => 'kos_siling',
		'label_field_index' => 4,
