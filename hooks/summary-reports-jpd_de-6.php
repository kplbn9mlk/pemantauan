<?php
	...
	$x = new StdClass;
	$x->TableTitle = "PANJANG JALAN SIAP";
	...
	$config_array = array(
		'reportHash' => 'y2vr3fgopbirkaygtjco',
		'request' => $_REQUEST,
		'groups_array' => $groups_array,
		'override_permissions' => false,
		'title' => 'PANJANG JALAN SIAP',
		'custom_where' => '',
		'table' => 'jpd_de',
		'label' => 'negeri',
		'group_function' => 'sum',
		'label_title' => 'Negeri',
		'value_title' => 'Sum of JPD DE',
		'thousands_separator' => ',',
		'decimal_point' => '.',
		...
		'group_function_field' => 'PanjangJalanM',
		'date_field' => 'TarikhSiapProjek',
		'date_field_index' => '15',
		'label_field_index' => 6,
