			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][11]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][11]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[11]); ?>" data-lightbox="pemohon_jpd-gambar_projek"><img src="thumbnail.php?i=<?php echo urlencode($record[11]); ?>&t=pemohon_jpd&f=gambar_projek&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][12]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][12]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[12]); ?>" data-lightbox="pemohon_jpd-gambar_projek_1"><img src="thumbnail.php?i=<?php echo urlencode($record[12]); ?>&t=pemohon_jpd&f=gambar_projek_1&v=tv" class="img-thumbnail"></a></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][14]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][14]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="<?php echo thisOr(get_embed('googlemap', $record[14], '', '', 'thumbnail_url'), 'blank.gif'); ?>" style="max-width: 100px; max-height: 50px; "></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][25]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][25]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[25]); ?>" data-lightbox="pemohon_jpd-gambar_projek2"><img src="thumbnail.php?i=<?php echo urlencode($record[25]); ?>&t=pemohon_jpd&f=gambar_projek2&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][26]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][26]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[26]); ?>" data-lightbox="pemohon_jpd-gambar_projek3"><img src="thumbnail.php?i=<?php echo urlencode($record[26]); ?>&t=pemohon_jpd&f=gambar_projek3&v=tv" class="img-thumbnail"></a></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
