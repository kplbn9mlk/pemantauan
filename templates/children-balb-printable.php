			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][17]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][17]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[17]); ?>" data-lightbox="balb-gambar1"><img src="thumbnail.php?i=<?php echo urlencode($record[17]); ?>&t=balb&f=gambar1&v=tv" class="img-thumbnail"></a></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][32]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][32]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[32]); ?>" data-lightbox="balb-gambar2"><img src="thumbnail.php?i=<?php echo urlencode($record[32]); ?>&t=balb&f=gambar2&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][33]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][33]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[33]); ?>" data-lightbox="balb-gambar3"><img src="thumbnail.php?i=<?php echo urlencode($record[33]); ?>&t=balb&f=gambar3&v=tv" class="img-thumbnail"></a></td>
