			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][18]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][18]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[18]); ?>" data-lightbox="jpd_khas-gambar_projek"><img src="thumbnail.php?i=<?php echo urlencode($record[18]); ?>&t=jpd_khas&f=gambar_projek&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][20]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][20]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="<?php echo thisOr(get_embed('googlemap', $record[20], '', '', 'thumbnail_url'), 'blank.gif'); ?>" style="max-width: 50px; max-height: 50px; "></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][34]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][34]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[34]; ?>&t=jpd_khas&f=gambar_projek_1&v=tv" class="img-thumbnail"></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][35]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][35]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[35]; ?>&t=jpd_khas&f=gambar_projek_2&v=tv" class="img-thumbnail"></td>
