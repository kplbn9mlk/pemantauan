			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][26]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][26]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[26]); ?>" data-lightbox="pprt-gambar1"><img src="thumbnail.php?i=<?php echo urlencode($record[26]); ?>&t=pprt&f=gambar1&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][27]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][27]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[27]); ?>" data-lightbox="pprt-gambar2"><img src="thumbnail.php?i=<?php echo urlencode($record[27]); ?>&t=pprt&f=gambar2&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][28]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][28]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[28]); ?>" data-lightbox="pprt-gambar3"><img src="thumbnail.php?i=<?php echo urlencode($record[28]); ?>&t=pprt&f=gambar3&v=tv" class="img-thumbnail"></a></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
