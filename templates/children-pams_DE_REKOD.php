...
<?php $current_table = 'pams_DE_REKOD'; ?>
<?php
			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][29]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][29]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[29]); ?>" data-lightbox="pams_DE_REKOD-gambar_projek"><img src="thumbnail.php?i=<?php echo urlencode($record[29]); ?>&t=pams_DE_REKOD&f=gambar_projek&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][30]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][30]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[30]); ?>" data-lightbox="pams_DE_REKOD-gambar_projek_1"><img src="thumbnail.php?i=<?php echo urlencode($record[30]); ?>&t=pams_DE_REKOD&f=gambar_projek_1&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][31]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][31]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[31]); ?>" data-lightbox="pams_DE_REKOD-gambar_projek_2"><img src="thumbnail.php?i=<?php echo urlencode($record[31]); ?>&t=pams_DE_REKOD&f=gambar_projek_2&v=tv" class="img-thumbnail"></a></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
